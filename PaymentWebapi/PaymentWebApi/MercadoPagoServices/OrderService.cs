...
namespace PaymentWebApi.MercadoPago
{
    public class OrderService : MercadoPagoService, IOrderService
    {
        ...
        public async Task<Order?> GetCurrentOrderAsync(long user_id, string cashier_external_id)
        {
        ...
        public async Task<bool> CreateNewOrderAsync(long user_id, string store_external_id, string cashier_external_id, OrderDto order)
        {
